...
public class AuthController {
         ...
         * 2. Tạo JWT reset token với thời hạn 15 phút (sử dụng mật khẩu hiện tại làm
         * chữ ký động)
         ...
         *
         * Luồng xử lý:
         * 1. Verify token (chữ ký tự động xác minh mật khẩu cũ không đổi, kiểm tra hết
         * hạn)
         * 2. Kiểm tra password khớp confirm password
         * 3. Cập nhật password mới (thao tác này tự động vô hiệu hóa token cũ do chữ ký
         * thay đổi)
         *
